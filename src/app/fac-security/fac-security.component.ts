...
@Component({
  selector: 'app-fac-security',
  standalone: true,
  imports: [ReactiveFormsModule],
  templateUrl: './fac-security.component.html',
  styleUrl: './fac-security.component.css'
})
export class FacSecurityComponent {
...
// });
  ...
  Edit() {
    ...
    this.formData.append('facID', this.userDetails.facID);
    ...
    this.ds.sendRequestWithMedia('edit-facPassword', this.formData).subscribe(
      (response) => {
